...
## CT-9.1: Extract RepertoireBrowserController from screen state
...
## CT-9.2: Add extension undo widget tests to AddLineScreen
...
## CT-9.3: DRY up action bar compact/full-width duplication
